...
using namespace std;
	...
	string number(int num){
		...
		switch(num%10){
			case 1: return "камушек"; break;
			case 2:
			case 3:
			case 4: return "камушка"; break;
			case 5:
			case 6:
			case 7:
			case 8:
			case 9:
			case 0: return "камушков"; break;
		}
	}
...
int main(){
	...
	do{
		...
		std::cout << "В куче " << stone_count << " " << number(stone_count) << std::endl;
		while(lvl != 4){
		...
		if (stone_count < 26){
			...
			if (stone_count == 0 || stone_count > 25){
						...
						std::cout << "Компьютер взял " << count_computer << " " << number(count_computer) << std::endl;
						if (stone_count == 0 || stone_count > 25){
